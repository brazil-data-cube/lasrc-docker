...
$ docker run --rm \
    ...
    -t lasrc:2.0.1 LC08_L1TP_220069_20190112_20190131_01_T1
```
...
$ docker run --rm \
    ...
    -v /path/to/output:/mnt/output-dir:rw \
    -v /path/to/lasrc_auxiliaries/L8:/mnt/atmcor_aux/lasrc/L8:ro \
    -t lasrc:2.0.1 S2A_MSIL1C_20190105T132231_N0207_R038_T23LLF_20190105T145859.SAFE
```
